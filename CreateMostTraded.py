...
MostDict[7].to_csv(os.path.join(THIS_FOLDER,'data/Most7.csv'))
MostDict[14].to_csv(os.path.join(THIS_FOLDER,'data/Most14.csv'))
MostDict[30].to_csv(os.path.join(THIS_FOLDER,'data/Most30.csv'))